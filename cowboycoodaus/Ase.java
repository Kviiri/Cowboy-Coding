...
/**
 * Ihmisillä on useita aseita. Aseita käytetään esim. ryöstön onnistumisen arvioinnissa.
...
public class Ase implements Comparable<Ase>{
     ...
     * @return palauttaa negatiivista jos tämä ase on tehokkuudeltaan huonompi jne. Lisää tietoa Comparablen toteuttamisesta löytyy sekä ohjan materiaalista, että Javan omasta APIsta
     *
     * 
     */
    @Override
